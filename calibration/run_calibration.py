...
# CONFIGURATION
# =============================================================================
DATA_DIR = "../data"  # Input directory for FITS/XYMQ files
REF_FILE = "./lmc_calibration_field.fits"  # Reference catalog (GAIA/HST)
OUTPUT_DIR = "./niriss_calibration"  # Output directory
